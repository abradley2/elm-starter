...
var _user$project$Login_Types$LoginModel = F2(
	function (a, b) {
		return {username: a, password: b};
	});
var _user$project$Login_Types$EDIT_PASSWORD = function (a) {
	return {ctor: 'EDIT_PASSWORD', _0: a};
};
var _user$project$Login_Types$EDIT_USERNAME = function (a) {
	return {ctor: 'EDIT_USERNAME', _0: a};
};
...
var _user$project$Types$MouseMsg = function (a) {
	return {ctor: 'MouseMsg', _0: a};
};

var _user$project$Login_State$editPassword = F2(
	function (loginModel, password) {
		return _elm_lang$core$Native_Utils.update(
			loginModel,
			{password: password});
	});
var _user$project$Login_State$editUsername = F2(
	function (loginModel, username) {
		return _elm_lang$core$Native_Utils.update(
			loginModel,
			{username: username});
	});
			...
			if (_p0._0.ctor === 'EDIT_USERNAME') {
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							login: A2(_user$project$Login_State$editUsername, model.login, _p0._0._0)
						}),
					_1: commands
				};
			} else {
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							login: A2(_user$project$Login_State$editPassword, model.login, _p0._0._0)
						}),
					_1: commands
				};
			}
...
var _user$project$State$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$mouse$Mouse$clicks(_user$project$Types$MouseMsg),
				_elm_lang$keyboard$Keyboard$downs(_user$project$Types$KeyMsg)
			]));
};
var _user$project$State$update = F2(
	function (msg, model) {
		var _p0 = A2(
			_user$project$Login_State$update,
			msg,
			{
				ctor: '_Tuple2',
				_0: model,
...
var _user$project$Login_View$editUsername = function (newUser) {
	return _user$project$Types$LoginMsg(
		_user$project$Login_Types$EDIT_USERNAME(newUser));
};
var _user$project$Login_View$editPassword = function (newPass) {
	return _user$project$Types$LoginMsg(
		_user$project$Login_Types$EDIT_PASSWORD(newPass));
};
var _user$project$Login_View$loginView = function (model) {
	return A2(
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$html$Html_Events$onInput(_user$project$Login_View$editUsername),
								_elm_lang$html$Html_Attributes$value(model.login.username)
							]),
						_elm_lang$core$Native_List.fromArray(
							[]))
					])),
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$html$Html_Events$onInput(_user$project$Login_View$editPassword),
								_elm_lang$html$Html_Attributes$value(model.login.password)
							]),
						_elm_lang$core$Native_List.fromArray(
							[]))
					]))
...
var _user$project$View$rootView = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$Login_View$loginView(model)
			]));
};
...
var _user$project$App$main = {
	main: _elm_lang$html$Html_App$program(
		{
			init: {ctor: '_Tuple2', _0: _user$project$State$initialState, _1: _elm_lang$core$Platform_Cmd$none},
