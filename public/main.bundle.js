...
var _user$project$Home_View$list = function (people) {
	return A2(
				...
				{ctor: '[]'},
				{
					...
					_1: {
						...
						_0: A2(
							...
							{ctor: '[]'},
							A2(_elm_lang$core$List$map, _user$project$Home_View$playerRow, people)),
						_1: {ctor: '[]'}
					}
				}),
			_1: {ctor: '[]'}
...
var _user$project$Home_View$nav = function (people) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
...
var _user$project$Messages$HomeMsg = function (a) {
