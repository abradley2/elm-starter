...
var _user$project$Component_FileInput$fileInput = function (params) {
	return A2(
		_rtfeldman$elm_css$Html_Styled$div,
		{
			ctor: '::',
			_0: _rtfeldman$elm_css$Html_Styled_Attributes$class('input-field'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _rtfeldman$elm_css$Html_Styled_Attributes$type_('file'),
					_1: {
						ctor: '::',
						_0: _rtfeldman$elm_css$Html_Styled_Attributes$id(params.id),
						_1: {
							ctor: '::',
							_0: A2(
								_rtfeldman$elm_css$Html_Styled_Events$on,
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _rtfeldman$elm_css$Html_Styled_Attributes$class('file-path validate'),
						_1: {
							ctor: '::',
							_0: _rtfeldman$elm_css$Html_Styled_Attributes$type_('text'),
							_1: {
								ctor: '::',
								_0: _rtfeldman$elm_css$Html_Styled_Attributes$value(params.value),
								_1: {ctor: '[]'}
							}
						}
					},
...
var _user$project$Component_FlatButton$flatButton = function (params) {
	return A2(
		_rtfeldman$elm_css$Html_Styled$span,
		{
			ctor: '::',
			_0: _rtfeldman$elm_css$Html_Styled_Attributes$class('waves-effect waves-teal btn-flat'),
			_1: {
				ctor: '::',
				_0: _rtfeldman$elm_css$Html_Styled_Events$onClick(params.onClick),
				_1: {ctor: '[]'}
			}
		},
		{
			ctor: '::',
			_0: _rtfeldman$elm_css$Html_Styled$text(params.label),
			_1: {ctor: '[]'}
		});
};
var _user$project$Component_FlatButton$Params = F2(
	function (a, b) {
		return {label: a, onClick: b};
	});

var _user$project$Component_Modal$modal = function (params) {
	return A2(
		_rtfeldman$elm_css$Html_Styled$div,
		{
			ctor: '::',
			_0: _rtfeldman$elm_css$Html_Styled_Attributes$style(
				{
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'transition', _1: '.5s'},
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: _rtfeldman$elm_css$Html_Styled_Events$onClick(params.onRequestClose),
				_1: {
					ctor: '::',
					_0: _rtfeldman$elm_css$Html_Styled_Attributes$css(
						A2(
							...
							params.open ? {
								ctor: '::',
								_0: _rtfeldman$elm_css$Css$backgroundColor(
									A4(_rtfeldman$elm_css$Css$rgba, 0, 0, 0, 0.67)),
								_1: {
									ctor: '::',
			...
			_0: A2(
				_rtfeldman$elm_css$Html_Styled$div,
				{
					...
					_0: _rtfeldman$elm_css$Html_Styled_Attributes$id(
						A2(_elm_lang$core$Basics_ops['++'], 'modal-', params.id)),
					_1: {
						ctor: '::',
						_0: _rtfeldman$elm_css$Html_Styled_Attributes$style(
							{
						...
						_1: {
							...
							_0: A3(
								...
								_elm_lang$core$Json_Decode$succeed(params.noop)),
							_1: {
								ctor: '::',
								_0: _rtfeldman$elm_css$Html_Styled_Attributes$css(
									A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _rtfeldman$elm_css$Html_Styled_Attributes$class('modal-content'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _rtfeldman$elm_css$Html_Styled_Attributes$class('modal-footer'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
...
var _user$project$Component_Modal$ModalParams = F6(
	function (a, b, c, d, e, f) {
		return {id: a, content: b, footer: c, open: d, noop: e, onRequestClose: f};
	});

var _user$project$Theme$accentInactiveColor = _rtfeldman$elm_css$Css$hex('#8FDD87');
var _user$project$Theme$accentActiveColor = _rtfeldman$elm_css$Css$hex('#44AA39');
var _user$project$Theme$accentColor = _rtfeldman$elm_css$Css$hex('#26a69a');
var _user$project$Theme$primaryInactiveColor = _rtfeldman$elm_css$Css$hex('#FC9A9F');
var _user$project$Theme$primaryActiveColor = _rtfeldman$elm_css$Css$hex('#CC444B');
var _user$project$Theme$primaryColor = _rtfeldman$elm_css$Css$hex('#ee6e73');
var _user$project$Theme$errorTextColor = _rtfeldman$elm_css$Css$hex('#e53935');
var _user$project$Theme$baseTextColor = A4(_rtfeldman$elm_css$Css$rgba, 0, 0, 0, 0.87);
var _user$project$Theme$white = _rtfeldman$elm_css$Css$hex('#FFF');
var _user$project$Theme$cardBoxShadow = '0 2px 2px 0 rgba(0,0,0,0.14), 0 3px 1px -2px rgba(0,0,0,0.12), 0 1px 5px 0 rgba(0,0,0,0.2)';

var _user$project$Component_QuestAction$questAction = function (params) {
	return A2(
		_rtfeldman$elm_css$Html_Styled$a,
		{
			ctor: '::',
			_0: _rtfeldman$elm_css$Html_Styled_Attributes$href(params.href),
			_1: {
				ctor: '::',
				_0: _rtfeldman$elm_css$Html_Styled_Attributes$css(
					{
						...
						_1: {
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _rtfeldman$elm_css$Css$color(_user$project$Theme$white),
									_1: {ctor: '[]'}
								}
							}
						}
		...
		},
		{
			...
			_0: A2(
							...
							_1: {
								...
								_1: {
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _rtfeldman$elm_css$Css$backgroundColor(_user$project$Theme$accentColor),
											_1: {
												ctor: '::',
				...
				{
					ctor: '::',
					_0: _rtfeldman$elm_css$Html_Styled$text(params.text),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
						...
						_0: A2(
							_rtfeldman$elm_css$Html_Styled$i,
							{
								...
								_0: _rtfeldman$elm_css$Html_Styled_Attributes$class(
									A2(_elm_lang$core$Basics_ops['++'], 'fa fa-lg fa-', params.icon)),
								_1: {
									ctor: '::',
									_0: _rtfeldman$elm_css$Html_Styled_Attributes$css(
										{
...
var _user$project$Types$Taco = F4(
	function (a, b, c, d) {
		return {flags: a, username: b, userId: c, routeData: d};
	});
var _user$project$Types$SessionInfo = F2(
	function (a, b) {
...
var _user$project$Types$SideQuest = F5(
	function (a, b, c, d, e) {
		return {name: a, description: b, guid: c, suggestedBy: d, id: e};
	});
var _user$project$Types$RecentPostedQuest = F8(
	function (a, b, c, d, e, f, g, h) {
		return {name: a, description: b, imageUrl: c, id: d, guid: e, username: f, userId: g, upvotes: h};
	});
var _user$project$Types$QuestDetailsResponse = F3(
	function (a, b, c) {
		return {quest: a, sideQuests: b, suggestedSideQuests: c};
	});
var _user$project$Types$GetSideQuestsResponse = F2(
	function (a, b) {
		return {quest: a, sideQuests: b};
	});
var _user$project$Types$QuestDetailsRoute = function (a) {
	return {ctor: 'QuestDetailsRoute', _0: a};
};
var _user$project$Types$CreateQuestRoute = {ctor: 'CreateQuestRoute'};
var _user$project$Types$MyAdventurerRoute = {ctor: 'MyAdventurerRoute'};
var _user$project$Types$SideQuestsRoute = function (a) {
					...
					},
					{
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _rtfeldman$elm_css$Html_Styled_Attributes$src(quest.imageUrl),
											_1: {
												ctor: '::',
												_0: _rtfeldman$elm_css$Html_Styled_Attributes$css(
													{
										...
										_0: A2(
											...
											},
											{
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _rtfeldman$elm_css$Html_Styled$text(quest.name),
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											}),
												...
												_rtfeldman$elm_css$Html_Styled$img,
												{
													...
													_0: _rtfeldman$elm_css$Html_Styled_Attributes$src(
														A2(
															...
															A2(_elm_lang$core$Basics_ops['++'], quest.userId, '/picture?type=small'))),
													_1: {ctor: '[]'}
												},
												{ctor: '[]'}),
											_1: {ctor: '[]'}
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _rtfeldman$elm_css$Html_Styled$text(quest.description),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: function () {
									var _p0 = params.actionSection;
									if (_p0.ctor === 'Just') {
										return A2(
											_rtfeldman$elm_css$Html_Styled$div,
											{
...
var _user$project$Component_QuestCard$questCardWithActionSection = F2(
	function (quest, params) {
		return A2(
			_user$project$Component_QuestCard$questCardBase,
			quest,
			{
				showUserImage: params.showUserImage,
				actionSection: _elm_lang$core$Maybe$Just(params.actionSection)
			});
	});
var _user$project$Component_QuestCard$questCard = F2(
	function (quest, params) {
		return A2(
			_user$project$Component_QuestCard$questCardBase,
			quest,
			{showUserImage: params.showUserImage, actionSection: _elm_lang$core$Maybe$Nothing});
	});

var _user$project$Component_RaisedButton$raisedButton = function (params) {
	return A2(
		_rtfeldman$elm_css$Html_Styled$span,
		{
			ctor: '::',
			...
			_0: function () {
				...
				if (_p0.ctor === 'Just') {
					return A2(
						...
						{
							ctor: '::',
							_0: _rtfeldman$elm_css$Html_Styled_Attributes$class('material-icons left'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
...
var _user$project$Component_RaisedButton$Params = F4(
	function (a, b, c, d) {
		return {disabled: a, icon: b, label: c, onClick: d};
	});

var _user$project$Component_Stepper$stepper = function (params) {
	return A2(
		_rtfeldman$elm_css$Html_Styled$div,
		{ctor: '[]'},
		A2(
						...
						},
						{
								...
								},
								{
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _rtfeldman$elm_css$Html_Styled$text(step.title),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
							...
							_1: {
								...
								_0: A2(
										...
										_0: _rtfeldman$elm_css$Html_Styled_Attributes$css(
											{
												...
												_0: A3(
													...
													_user$project$Theme$accentColor),
												_1: {
													ctor: '::',
									...
									{
										ctor: '::',
										_0: _rtfeldman$elm_css$Html_Styled$text(step.description),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
...
var _user$project$Component_TextArea$textArea = function (params) {
	return A2(
		_rtfeldman$elm_css$Html_Styled$div,
		{
			ctor: '::',
			_0: _rtfeldman$elm_css$Html_Styled_Attributes$class(
				A2(
					_elm_lang$core$Basics_ops['++'],
					'input-field ',
					A2(_elm_lang$core$Maybe$withDefault, '', params.$class))),
			_1: {
				ctor: '::',
				_0: _rtfeldman$elm_css$Html_Styled_Attributes$id(params.id),
				_1: {
					ctor: '::',
					_0: A2(_rtfeldman$elm_css$Html_Styled_Attributes$attribute, 'data-js-component', 'textField'),
					_1: {ctor: '[]'}
				}
			}
		},
		{
			...
			_0: A2(
				_rtfeldman$elm_css$Html_Styled$textarea,
				{
					ctor: '::',
					_0: _rtfeldman$elm_css$Html_Styled_Attributes$id(
						A2(_elm_lang$core$Basics_ops['++'], 'textarea-', params.id)),
					_1: {
						ctor: '::',
						_0: _rtfeldman$elm_css$Html_Styled_Attributes$class('materialize-textarea'),
						_1: {
							ctor: '::',
							_0: _rtfeldman$elm_css$Html_Styled_Attributes$value(params.value),
							_1: {
								ctor: '::',
								_0: _rtfeldman$elm_css$Html_Styled_Events$onInput(params.onInput),
								_1: {
									ctor: '::',
									_0: _rtfeldman$elm_css$Html_Styled_Attributes$style(
										{
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 'min-height', _1: '80px'},
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _rtfeldman$elm_css$Html_Styled_Attributes$for(
							A2(_elm_lang$core$Basics_ops['++'], 'textarea-', params.id)),
						_1: {ctor: '[]'}
					},
					{
...
var _user$project$Component_TextField$textField = function (params) {
	return A2(
		_rtfeldman$elm_css$Html_Styled$div,
		{
			ctor: '::',
			_0: _rtfeldman$elm_css$Html_Styled_Attributes$class(
				A2(
					_elm_lang$core$Basics_ops['++'],
					'input-field data-elm-lifecycle ',
					A2(_elm_lang$core$Maybe$withDefault, '', params.$class))),
			_1: {
				ctor: '::',
				_0: _rtfeldman$elm_css$Html_Styled_Attributes$id(params.id),
		...
		},
		{
			...
			_0: A2(
				_rtfeldman$elm_css$Html_Styled$input,
				{
					ctor: '::',
					_0: _rtfeldman$elm_css$Html_Styled_Attributes$id(
						A2(_elm_lang$core$Basics_ops['++'], 'textfield-', params.id)),
					_1: {
						ctor: '::',
						_0: _rtfeldman$elm_css$Html_Styled_Attributes$value(params.value),
						_1: {
...
var _user$project$Ports$navigate = _elm_lang$core$Native_Platform.incomingPort('navigate', _elm_lang$core$Json_Decode$string);

var _user$project$Util$onTacoUpdate = F6(
	function (tacoMsg, taco, messageType, getter, setter, reducer) {
		var _p0 = tacoMsg;
		if (_p0.ctor === 'TacoNoOp') {
			return function (_p1) {
				var _p2 = _p1;
			...
			return function (_p3) {
				...
				var updatedPageModel = _p5._0;
				var cmd = _p5._1;
				return {
					ctor: '_Tuple2',
					_0: A2(setter, _p6, updatedPageModel),
...
var _user$project$Util$getReducerFactory = F8(
	function (model, taco, tacoCmd, commands, messageType, pageModel, setter, reducer) {
		var _p7 = reducer(
			{ctor: '_Tuple2', _0: pageModel, _1: taco});
		var updatedPageModel = _p7._0;
		var cmd = _p7._1;
		return {
			ctor: '_Tuple2',
...
var _user$project$Request_SessionRequest$loadSession = F2(
	function (apiEndpoint, queryParams) {
		return _elm_lang$http$Http$request(
			{
				method: 'GET',
				headers: {ctor: '[]'},
				url: A2(
					_elm_lang$core$Basics_ops['++'],
					apiEndpoint,
					A2(_elm_lang$core$Basics_ops['++'], 'session/load', queryParams)),
				body: _elm_lang$http$Http$emptyBody,
...
var _user$project$Request_CreateQuestRequest$decodeQuest = A5(
	...
	A2(
		...
		_elm_lang$core$Json_Decode$string));
var _user$project$Request_CreateQuestRequest$createQuestRequest = F2(
	function (apiEndpoint, quest) {
		return _elm_lang$http$Http$request(
			{
				method: 'POST',
				headers: {ctor: '[]'},
...
var _user$project$Page_CreateQuest_Update$initialModel = {questName: '', questDescription: '', questImageUrl: '/placeholder.png', imageUploadModalOpen: false, imageUploadModalFor: _elm_lang$core$Maybe$Nothing, imageUploadPath: _elm_lang$core$Maybe$Nothing, questImageUploadPending: false, questImageUploadError: false, submitPending: false, submitError: false};
var _user$project$Page_CreateQuest_Update$onTacoMsg = F2(
	function (tacoMsg, _p0) {
		var _p1 = _p0;
		var _p2 = tacoMsg;
		if (_p2.ctor === 'CreateQuestRoute') {
			return {ctor: '_Tuple2', _0: _user$project$Page_CreateQuest_Update$initialModel, _1: _elm_lang$core$Platform_Cmd$none};
		} else {
			return {ctor: '_Tuple2', _0: _p1._0, _1: _elm_lang$core$Platform_Cmd$none};
		}
	});
var _user$project$Page_CreateQuest_Update$Model = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
					return function (f) {
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return {questName: a, questDescription: b, questImageUrl: c, imageUploadModalOpen: d, imageUploadModalFor: e, imageUploadPath: f, questImageUploadPending: g, questImageUploadError: h, submitPending: i, submitError: j};
									};
								};
							};
						};
...
var _user$project$Page_CreateQuest_Update$UploadQuestImageFinished = function (a) {
	return {ctor: 'UploadQuestImageFinished', _0: a};
};
var _user$project$Page_CreateQuest_Update$SubmitCreateQuestResult = function (a) {
	return {ctor: 'SubmitCreateQuestResult', _0: a};
};
var _user$project$Page_CreateQuest_Update$onMsg = F2(
	function (msg, _p3) {
		var _p4 = _p3;
		var _p6 = _p4._0;
		var _p5 = msg;
			...
			case 'UploadQuestImageFinished':
				return _p5._0._0 ? {
					...
					_0: _elm_lang$core$Native_Utils.update(
						_p6,
						{questImageUploadPending: false, questImageUploadError: false, questImageUrl: _p5._0._1, imageUploadModalOpen: false}),
			...
			case 'SubmitCreateQuest':
				return {
					...
					_1: A2(
						...
						_user$project$Page_CreateQuest_Update$SubmitCreateQuestResult,
						A2(
							_user$project$Request_CreateQuestRequest$createQuestRequest,
							_p4._1.flags.apiEndpoint,
...
var _user$project$Page_CreateQuest_Update$SubmitCreateQuest = {ctor: 'SubmitCreateQuest'};
var _user$project$Page_CreateQuest_Update$ConfirmFileUpload = function (a) {
	return {ctor: 'ConfirmFileUpload', _0: a};
};
var _user$project$Page_CreateQuest_Update$OnFileChosen = function (a) {
	return {ctor: 'OnFileChosen', _0: a};
};
var _user$project$Page_CreateQuest_Update$HideFileUploadModal = {ctor: 'HideFileUploadModal'};
var _user$project$Page_CreateQuest_Update$ShowFileUploadModal = {ctor: 'ShowFileUploadModal'};
var _user$project$Page_CreateQuest_Update$EditQuestDescription = function (a) {
	return {ctor: 'EditQuestDescription', _0: a};
};
var _user$project$Page_CreateQuest_Update$EditQuestName = function (a) {
	return {ctor: 'EditQuestName', _0: a};
};
var _user$project$Page_CreateQuest_Update$NoOp = {ctor: 'NoOp'};
	...
	return _elm_lang$core$Json_Encode$object(
		{
			...
			_0: {
				ctor: '_Tuple2',
				_0: 'name',
				_1: _elm_lang$core$Json_Encode$string(sideQuest.name)
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'description',
					_1: _elm_lang$core$Json_Encode$string(sideQuest.description)
				},
				_1: {ctor: '[]'}
			}
		});
...
var _user$project$Request_QuestsRequest$decodeQuest = A9(
	...
	_user$project$Types$RecentPostedQuest,
	...
	A2(_elm_lang$core$Json_Decode$field, 'upvotes', _elm_lang$core$Json_Decode$int));
var _user$project$Request_QuestsRequest$decodeSideQuest = A6(
	_elm_lang$core$Json_Decode$map5,
	_user$project$Types$SideQuest,
	A2(_elm_lang$core$Json_Decode$field, 'name', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'description', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'guid', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'suggestedBy', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'id', _elm_lang$core$Json_Decode$string));
var _user$project$Request_QuestsRequest$decodeSideQuestsList = _elm_lang$core$Json_Decode$list(_user$project$Request_QuestsRequest$decodeSideQuest);
var _user$project$Request_QuestsRequest$decodeGetSideQuestsResponse = A3(
	_elm_lang$core$Json_Decode$map2,
	_user$project$Types$GetSideQuestsResponse,
	A2(_elm_lang$core$Json_Decode$field, 'quest', _user$project$Request_QuestsRequest$decodeQuest),
	A2(_elm_lang$core$Json_Decode$field, 'sideQuests', _user$project$Request_QuestsRequest$decodeSideQuestsList));
var _user$project$Request_QuestsRequest$getSideQuests = F3(
				...
				url: A2(
					...
					A2(
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							userId,
							A2(_elm_lang$core$Basics_ops['++'], '?questId=', questId)))),
				body: _elm_lang$http$Http$emptyBody,
				expect: _elm_lang$http$Http$expectJson(_user$project$Request_QuestsRequest$decodeGetSideQuestsResponse),
				timeout: _elm_lang$core$Maybe$Nothing,
				withCredentials: true
			});
	});
var _user$project$Request_QuestsRequest$decodeQuestDetails = A4(
	_elm_lang$core$Json_Decode$map3,
	_user$project$Types$QuestDetailsResponse,
	A2(_elm_lang$core$Json_Decode$field, 'quest', _user$project$Request_QuestsRequest$decodeQuest),
	A2(
		_elm_lang$core$Json_Decode$field,
		'sideQuests',
				...
				url: A2(
					...
					A2(
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							userId,
							A2(_elm_lang$core$Basics_ops['++'], '/', questId)))),
				body: _elm_lang$http$Http$emptyBody,
				expect: _elm_lang$http$Http$expectJson(_user$project$Request_QuestsRequest$decodeQuestDetails),
				timeout: _elm_lang$core$Maybe$Nothing,
				withCredentials: true
			});
	});
	...
	return _elm_lang$http$Http$request(
		{
			...
			url: A2(
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					'quests/',
					A2(_elm_lang$core$Basics_ops['++'], params.questId, '/decidesidequest'))),
			body: _elm_lang$http$Http$jsonBody(
				_elm_lang$core$Json_Encode$object(
					{
						...
						_0: {
							ctor: '_Tuple2',
							_0: 'sideQuestId',
							_1: _elm_lang$core$Json_Encode$string(params.sideQuestId)
						},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'isAccepted',
								_1: _elm_lang$core$Json_Encode$bool(params.isAccepted)
							},
							_1: {ctor: '[]'}
						}
					})),
...
var _user$project$Request_QuestsRequest$suggestSideQuest = F3(
	function (apiEndpoint, quest, sideQuest) {
		return _elm_lang$http$Http$request(
			{
				method: 'POST',
				headers: {ctor: '[]'},
				...
				body: _elm_lang$http$Http$jsonBody(
					_user$project$Request_QuestsRequest$encodeSideQuest(sideQuest)),
...
var _user$project$Request_QuestsRequest$getQuests = function (apiEndpoint) {
	return _elm_lang$http$Http$request(
		{
			method: 'GET',
			headers: {ctor: '[]'},
			url: A2(_elm_lang$core$Basics_ops['++'], apiEndpoint, 'quests'),
			body: _elm_lang$http$Http$emptyBody,
			expect: _elm_lang$http$Http$expectJson(_user$project$Request_QuestsRequest$decodeQuestsList),
			timeout: _elm_lang$core$Maybe$Nothing,
			withCredentials: true
		});
};
var _user$project$Request_QuestsRequest$getQuestsByUser = F2(
	function (apiEndpoint, userId) {
		return _elm_lang$http$Http$request(
			{
				method: 'GET',
				headers: {ctor: '[]'},
				url: A2(
					_elm_lang$core$Basics_ops['++'],
					apiEndpoint,
					A2(_elm_lang$core$Basics_ops['++'], 'quests/', userId)),
				body: _elm_lang$http$Http$emptyBody,
				expect: _elm_lang$http$Http$expectJson(_user$project$Request_QuestsRequest$decodeQuestsList),
				timeout: _elm_lang$core$Maybe$Nothing,
				withCredentials: true
...
var _user$project$Request_QuestsRequest$DecideSideQuestParams = F4(
	function (a, b, c, d) {
		return {apiEndpoint: a, questId: b, sideQuestId: c, isAccepted: d};
	});

var _user$project$Page_MyAdventurer_Update$onMsg = F2(
	function (msg, _p0) {
		var _p1 = _p0;
		var _p3 = _p1._0;
		var _p2 = msg;
...
var _user$project$Page_MyAdventurer_Update$initialModel = {
	quests: {ctor: '[]'}
};
var _user$project$Page_MyAdventurer_Update$Model = function (a) {
	return {quests: a};
};
var _user$project$Page_MyAdventurer_Update$GetQuestsByUserResult = function (a) {
	return {ctor: 'GetQuestsByUserResult', _0: a};
};
var _user$project$Page_MyAdventurer_Update$onTacoMsg = F2(
	function (tacoMsg, _p4) {
		...
		if (_p6.ctor === 'MyAdventurerRoute') {
			var result = A2(
				_elm_lang$core$Maybe$map,
				function (userId) {
					return A2(_user$project$Request_QuestsRequest$getQuestsByUser, _p9.flags.apiEndpoint, userId);
				},
				_p9.userId);
			var _p7 = result;
			if (_p7.ctor === 'Just') {
				return {
					ctor: '_Tuple2',
					_0: _p8,
					_1: A2(_elm_lang$http$Http$send, _user$project$Page_MyAdventurer_Update$GetQuestsByUserResult, _p7._0)
				};
			} else {
...
var _user$project$Page_MyAdventurer_Update$NoOp = {ctor: 'NoOp'};

var _user$project$Page_QuestDetails_Update$isOwnQuest = F2(
	function (taco, model) {
		var _p0 = A2(
			_elm_lang$core$Maybe$withDefault,
			{ctor: '_Tuple2', _0: 'foo', _1: 'bar'},
			A3(
				_elm_lang$core$Maybe$map2,
				F2(
					function (quest, userId) {
						return {ctor: '_Tuple2', _0: quest.userId, _1: userId};
					}),
				model.quest,
				taco.userId));
		var questUserId = _p0._0;
		var userId = _p0._1;
		return _elm_lang$core$Native_Utils.eq(questUserId, userId);
	});
var _user$project$Page_QuestDetails_Update$initialModel = {quest: _elm_lang$core$Maybe$Nothing, sideQuests: _elm_lang$core$Maybe$Nothing, suggestedSideQuests: _elm_lang$core$Maybe$Nothing, showingSuggestedSideQuests: false, decidingSideQuest: _elm_lang$core$Maybe$Nothing, questFormOpen: false, sideQuestName: '', sideQuestDescription: '', suggestingSideQuest: false, suggestSideQuestSuccess: _elm_lang$core$Maybe$Nothing};
var _user$project$Page_QuestDetails_Update$Model = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
					return function (f) {
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return {quest: a, sideQuests: b, suggestedSideQuests: c, showingSuggestedSideQuests: d, decidingSideQuest: e, questFormOpen: f, sideQuestName: g, sideQuestDescription: h, suggestingSideQuest: i, suggestSideQuestSuccess: j};
									};
								};
							};
						};
...
var _user$project$Page_QuestDetails_Update$EditSideQuestDescription = function (a) {
	return {ctor: 'EditSideQuestDescription', _0: a};
};
var _user$project$Page_QuestDetails_Update$EditSideQuestName = function (a) {
	return {ctor: 'EditSideQuestName', _0: a};
};
var _user$project$Page_QuestDetails_Update$SuggestSideQuestResult = function (a) {
	return {ctor: 'SuggestSideQuestResult', _0: a};
};
var _user$project$Page_QuestDetails_Update$SubmitSideQuestForm = {ctor: 'SubmitSideQuestForm'};
var _user$project$Page_QuestDetails_Update$HideSideQuestForm = {ctor: 'HideSideQuestForm'};
var _user$project$Page_QuestDetails_Update$ShowSideQuestForm = {ctor: 'ShowSideQuestForm'};
var _user$project$Page_QuestDetails_Update$DeclineSideQuest = function (a) {
	return {ctor: 'DeclineSideQuest', _0: a};
};
var _user$project$Page_QuestDetails_Update$AcceptSideQuest = function (a) {
	return {ctor: 'AcceptSideQuest', _0: a};
};
var _user$project$Page_QuestDetails_Update$ToggleShowingSideQuestModal = function (a) {
	return {ctor: 'ToggleShowingSideQuestModal', _0: a};
};
var _user$project$Page_QuestDetails_Update$DeclineSuggestedSideQuest = {ctor: 'DeclineSuggestedSideQuest'};
var _user$project$Page_QuestDetails_Update$AcceptSuggestedSideQuest = {ctor: 'AcceptSuggestedSideQuest'};
var _user$project$Page_QuestDetails_Update$ToggleShowingSuggestedSideQuests = function (a) {
	return {ctor: 'ToggleShowingSuggestedSideQuests', _0: a};
};
var _user$project$Page_QuestDetails_Update$DecideSideQuestResult = function (a) {
	return {ctor: 'DecideSideQuestResult', _0: a};
};
var _user$project$Page_QuestDetails_Update$decideOnSuggestedSideQuest = F3(
	function (taco, model, isAccepted) {
		var request = A3(
			_elm_lang$core$Maybe$map2,
			F2(
				function (quest, sideQuest) {
					return A2(
						_elm_lang$http$Http$send,
						_user$project$Page_QuestDetails_Update$DecideSideQuestResult,
						_user$project$Request_QuestsRequest$decideSideQuest(
							{apiEndpoint: taco.flags.apiEndpoint, isAccepted: isAccepted, sideQuestId: sideQuest.id, questId: quest.id}));
				}),
			model.quest,
			model.decidingSideQuest);
		return A2(_elm_lang$core$Maybe$withDefault, _elm_lang$core$Platform_Cmd$none, request);
	});
var _user$project$Page_QuestDetails_Update$onMsg = F2(
	function (msg, _p1) {
		var _p2 = _p1;
		var _p8 = _p2._1;
		var _p7 = _p2._0;
		...
		switch (_p3.ctor) {
			...
			case 'ToggleShowingSuggestedSideQuests':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						_p7,
						{showingSuggestedSideQuests: _p3._0, questFormOpen: false}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'AcceptSuggestedSideQuest':
				return {
					...
					_1: A3(_user$project$Page_QuestDetails_Update$decideOnSuggestedSideQuest, _p8, _p7, true)
				};
			case 'DeclineSuggestedSideQuest':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						_p7,
						{decidingSideQuest: _elm_lang$core$Maybe$Nothing, quest: _elm_lang$core$Maybe$Nothing, sideQuests: _elm_lang$core$Maybe$Nothing, suggestedSideQuests: _elm_lang$core$Maybe$Nothing}),
					_1: A3(_user$project$Page_QuestDetails_Update$decideOnSuggestedSideQuest, _p8, _p7, false)
				};
			...
			case 'SuggestSideQuestResult':
				if (_p3._0.ctor === 'Err') {
					...
					var updatedModel = A2(
						...
						'is own quest ',
						A2(_user$project$Page_QuestDetails_Update$isOwnQuest, _p8, _p7)) ? _elm_lang$core$Native_Utils.update(
						_p7,
						{
							sideQuests: _elm_lang$core$Maybe$Just(_p6)
						}) : _elm_lang$core$Native_Utils.update(
						_p7,
						{
							suggestedSideQuests: _elm_lang$core$Maybe$Just(_p6)
						});
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
			...
			case 'ShowSideQuestForm':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						_p7,
						{questFormOpen: true, sideQuestName: '', sideQuestDescription: '', showingSuggestedSideQuests: false}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
					...
					_1: A2(
						...
						A2(
							...
							function (quest) {
								return A2(
									_elm_lang$http$Http$send,
									_user$project$Page_QuestDetails_Update$SuggestSideQuestResult,
									A3(
										_user$project$Request_QuestsRequest$suggestSideQuest,
										_p8.flags.apiEndpoint,
										quest,
										{guid: '', name: _p7.sideQuestName, description: _p7.sideQuestDescription, suggestedBy: '', id: ''}));
							},
							_p7.quest))
				};
			...
			default:
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						_p7,
						{sideQuestDescription: _p3._0}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
var _user$project$Page_QuestDetails_Update$GetQuestDetailsResult = function (a) {
	return {ctor: 'GetQuestDetailsResult', _0: a};
};
var _user$project$Page_QuestDetails_Update$onTacoMsg = F2(
	function (tacoMsg, _p9) {
		var _p10 = _p9;
		var _p11 = tacoMsg;
		if (_p11.ctor === 'QuestDetailsRoute') {
			var paramArray = _elm_lang$core$Array$fromList(
				A2(_elm_lang$core$String$split, ':', _p11._0));
			var request = A3(
				_elm_lang$core$Maybe$map2,
				F2(
					function (userId, questId) {
						return A2(
							_elm_lang$http$Http$send,
							_user$project$Page_QuestDetails_Update$GetQuestDetailsResult,
							A3(_user$project$Request_QuestsRequest$getQuestDetails, _p10._1.flags.apiEndpoint, userId, questId));
					}),
				A2(_elm_lang$core$Array$get, 0, paramArray),
				A2(_elm_lang$core$Array$get, 1, paramArray));
			return {
				ctor: '_Tuple2',
				_0: _user$project$Page_QuestDetails_Update$initialModel,
...
var _user$project$Page_QuestDetails_Update$NoOp = {ctor: 'NoOp'};

var _user$project$Page_Quests_Update$onMsg = F2(
	function (msg, _p0) {
		var _p1 = _p0;
		var _p3 = _p1._0;
		var _p2 = msg;
...
var _user$project$Page_Quests_Update$initialModel = {
	questList: {ctor: '[]'}
};
var _user$project$Page_Quests_Update$Model = function (a) {
	return {questList: a};
};
var _user$project$Page_Quests_Update$GetQuestsResult = function (a) {
	return {ctor: 'GetQuestsResult', _0: a};
};
var _user$project$Page_Quests_Update$onTacoMsg = F2(
	function (tacoMsg, _p4) {
		var _p5 = _p4;
		var _p7 = _p5._0;
		var _p6 = tacoMsg;
		if (_p6.ctor === 'QuestsRoute') {
			return {
				...
				_1: A2(
					_elm_lang$http$Http$send,
					_user$project$Page_Quests_Update$GetQuestsResult,
					_user$project$Request_QuestsRequest$getQuests(_p5._1.flags.apiEndpoint))
			};
		} else {
			return {ctor: '_Tuple2', _0: _p7, _1: _elm_lang$core$Platform_Cmd$none};
		}
	});
var _user$project$Page_Quests_Update$NoOp = {ctor: 'NoOp'};

var _user$project$Page_Layout$sideNavtransform = function (isOpen) {
	return isOpen ? 'translateX(0%)' : 'translateX(-105%)';
};
var _user$project$Page_Layout$navs = F2(
	function (model, taco) {
		return {
			ctor: '::',
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						_rtfeldman$elm_css$Html_Styled$a,
						{
							...
							_1: {
								ctor: '::',
								_0: A2(_rtfeldman$elm_css$Html_Styled_Attributes$attribute, 'data-link', '/quests'),
								_1: {ctor: '[]'}
							}
						},
						{
			...
			_1: {
				...
				_0: A2(
					...
					{ctor: '[]'},
					{
						ctor: '::',
						_0: function () {
							if (!_elm_lang$core$Native_Utils.eq(taco.userId, _elm_lang$core$Maybe$Nothing)) {
								return A2(
									_rtfeldman$elm_css$Html_Styled$a,
									{
										ctor: '::',
										...
										_1: {
											ctor: '::',
											_0: A2(_rtfeldman$elm_css$Html_Styled_Attributes$attribute, 'data-link', '/profile'),
											_1: {ctor: '[]'}
										}
									},
									{
...
var _user$project$Page_Layout$onMsg = F2(
	function (msg, _p1) {
		var _p2 = _p1;
		var _p4 = _p2._0;
		var _p3 = msg;
		return {
			...
			_0: _elm_lang$core$Native_Utils.update(
				_p4,
				{sidenavOpen: !_p4.sidenavOpen}),
			_1: _elm_lang$core$Platform_Cmd$none
		};
	});
var _user$project$Page_Layout$onTacoMsg = F2(
	function (tacoMsg, _p5) {
		var _p6 = _p5;
		return {ctor: '_Tuple2', _0: _p6._0, _1: _elm_lang$core$Platform_Cmd$none};
	});
var _user$project$Page_Layout$initialModel = {sidenavOpen: false};
var _user$project$Page_Layout$Model = function (a) {
	return {sidenavOpen: a};
};
var _user$project$Page_Layout$ToggleSidenav = {ctor: 'ToggleSidenav'};
var _user$project$Page_Layout$toggleSidenavButton = A2(
	_rtfeldman$elm_css$Html_Styled$a,
	{
		ctor: '::',
		...
		_1: {
			...
			_1: {
				ctor: '::',
				_0: _rtfeldman$elm_css$Html_Styled_Events$onClick(_user$project$Page_Layout$ToggleSidenav),
				_1: {
					ctor: '::',
					_0: _rtfeldman$elm_css$Html_Styled_Attributes$css(
						{
...
var _user$project$Page_Layout$navbar = F2(
	function (model, taco) {
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _user$project$Page_Layout$toggleSidenavButton,
						_1: {
							ctor: '::',
							_0: A2(
								_rtfeldman$elm_css$Html_Styled$a,
							...
							_1: {
								...
								_0: A2(
									...
									A2(_user$project$Page_Layout$navs, model, taco)),
								_1: {ctor: '[]'}
							}
						}
					}),
...
var _user$project$Page_Layout$render = F4(
		...
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					messageMap,
					A2(_user$project$Page_Layout$navbar, model, taco)),
				_1: {
					ctor: '::',
					_0: A2(
						_rtfeldman$elm_css$Html_Styled$map,
											...
											_0: _rtfeldman$elm_css$Html_Styled_Attributes$style(
												{
													...
													_0: {
														ctor: '_Tuple2',
														_0: 'transform',
														_1: _user$project$Page_Layout$sideNavtransform(model.sidenavOpen)
													},
													_1: {
														ctor: '::',
														_0: {ctor: '_Tuple2', _0: 'transition', _1: '.25s'},
...
var _user$project$Page_MyAdventurer_View$noQuests = function (model) {
	return _elm_lang$core$Native_Utils.eq(
		_elm_lang$core$List$length(model.quests),
		0);
};
var _user$project$Page_MyAdventurer_View$topCopy = function (model) {
	return _user$project$Page_MyAdventurer_View$noQuests(model) ? A2(
		...
		{
			ctor: '::',
			_0: _rtfeldman$elm_css$Html_Styled$text('it appears you don\'t have any quests...'),
			_1: {
				ctor: '::',
				_0: A2(
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _rtfeldman$elm_css$Html_Styled_Attributes$href('/newquest'),
							_1: {
								ctor: '::',
								_0: A2(_rtfeldman$elm_css$Html_Styled_Attributes$attribute, 'data-link', '/newquest'),
								_1: {ctor: '[]'}
							}
						},
						{
							ctor: '::',
							_0: _rtfeldman$elm_css$Html_Styled$text('Let\'s create one!'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
		...
		{
			ctor: '::',
			_0: _rtfeldman$elm_css$Html_Styled$text('Here are your active quests, adventurer!'),
			_1: {
				ctor: '::',
				_0: A2(
					_rtfeldman$elm_css$Html_Styled$br,
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _rtfeldman$elm_css$Html_Styled$text('Perhaps you\'d like to embark upon another?'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _user$project$Page_MyAdventurer_View$render = F2(
	function (taco, model) {
		return A2(
			_rtfeldman$elm_css$Html_Styled$div,
			{
			...
			{
				ctor: '::',
				_0: _user$project$Page_MyAdventurer_View$topCopy(model),
				_1: {
					ctor: '::',
					_0: A2(
						_rtfeldman$elm_css$Html_Styled$div,
...
var _user$project$Page_Quests_QuestAction$questAction = function (params) {
	return A2(
		_rtfeldman$elm_css$Html_Styled$a,
		{
			ctor: '::',
			...
			_1: {
				ctor: '::',
				_0: A2(_rtfeldman$elm_css$Html_Styled_Attributes$attribute, 'data-link', params.href),
				_1: {
					ctor: '::',
					_0: _rtfeldman$elm_css$Html_Styled_Attributes$css(
						{
...
var _user$project$Page_Quests_View$render = F2(
	function (taco, model) {
		return A2(
			_rtfeldman$elm_css$Html_Styled$div,
			{
							...
							return A2(
								...
								quest,
								{
									...
									actionSection: A2(
										...
										{
											ctor: '::',
											_0: _user$project$Page_Quests_QuestAction$questAction(
												{
													icon: 'list',
													text: 'Details',
													href: A2(
...
var _user$project$Page_CreateQuest_View$fileInputId = 'create-quest-image-upload';
var _user$project$Page_CreateQuest_View$validQuest = function (model) {
	return A2(
		_elm_lang$core$List$all,
		function (val) {
		...
		{
			ctor: '::',
			_0: !_elm_lang$core$Native_Utils.eq(model.questName, ''),
			_1: {ctor: '[]'}
		});
};
var _user$project$Page_CreateQuest_View$helperText = '\nTHY QUEST (if you choose to accept it) IS\n';
var _user$project$Page_CreateQuest_View$render = F2(
	function (taco, model) {
		return A2(
			_rtfeldman$elm_css$Html_Styled$div,
			{ctor: '[]'},
						...
						_0: _user$project$Component_Modal$modal(
							{
								...
								id: A2(_elm_lang$core$Maybe$withDefault, '', model.imageUploadModalFor),
								content: A2(
									_rtfeldman$elm_css$Html_Styled$div,
									{ctor: '[]'},
									{
											...
											_0: A2(
												...
												},
												{
													...
													_0: _user$project$Component_FileInput$fileInput(
														{
															id: _user$project$Page_CreateQuest_View$fileInputId,
															label: 'Image (max size 2mb)',
															onChange: _user$project$Page_CreateQuest_Update$OnFileChosen,
															value: A2(_elm_lang$core$Maybe$withDefault, '', model.imageUploadPath)
														}),
													_1: {ctor: '[]'}
												}),
											_1: {
												...
												_0: A2(
													...
													},
													{
														...
														_0: _user$project$Component_FlatButton$flatButton(
															{label: 'Cancel', onClick: _user$project$Page_CreateQuest_Update$HideFileUploadModal}),
														_1: {
															ctor: '::',
															_0: function () {
																var _p0 = model.imageUploadPath;
																if (_p0.ctor === 'Just') {
																	return _user$project$Component_RaisedButton$raisedButton(
																		{
																			...
																			onClick: _user$project$Page_CreateQuest_Update$ConfirmFileUpload(_user$project$Page_CreateQuest_View$fileInputId)
																		});
																} else {
																	return A2(
																		_rtfeldman$elm_css$Html_Styled$div,
												...
												_1: {
													...
													_0: A2(
														...
														},
														{
															ctor: '::',
															_0: _rtfeldman$elm_css$Html_Styled$text(
																model.questImageUploadError ? 'There was an error uploading your image. Please ensure images are less than 2mb' : ''),
															_1: {ctor: '[]'}
														}),
													_1: {ctor: '[]'}
												}
								...
								footer: A2(
									...
									{ctor: '[]'},
									{ctor: '[]'}),
								noop: _user$project$Page_CreateQuest_Update$NoOp,
								onRequestClose: _user$project$Page_CreateQuest_Update$HideFileUploadModal
							}),
						_1: {ctor: '[]'}
					}),
				_1: {
							...
							_0: A2(
								...
								},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _rtfeldman$elm_css$Html_Styled$text(_user$project$Page_CreateQuest_View$helperText),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}),
																...
																_0: A2(
																	...
																	},
																	{
																		...
																		_0: A2(
																			...
																			{
																				ctor: '::',
																				_0: _rtfeldman$elm_css$Html_Styled_Attributes$src(model.questImageUrl),
																				_1: {ctor: '[]'}
																			},
																			{ctor: '[]'}),
																		_1: {
																			...
																			_0: A2(
																				...
																				},
																				{
																					...
																					_0: A2(
																						...
																						{
																							ctor: '::',
																							_0: _rtfeldman$elm_css$Html_Styled$text(model.questName),
																							_1: {ctor: '[]'}
																						}),
																					_1: {ctor: '[]'}
																				}),
																			_1: {
																				...
																				_0: A2(
																					_rtfeldman$elm_css$Html_Styled$a,
																					{
																						...
																						_1: {
																							ctor: '::',
																							_0: _rtfeldman$elm_css$Html_Styled_Events$onClick(_user$project$Page_CreateQuest_Update$ShowFileUploadModal),
																							_1: {ctor: '[]'}
																						}
																					},
																					{
																	...
																	_0: A2(
																		...
																		},
																		{
																			...
																			_0: _user$project$Component_TextField$textField(
																				{id: 'name-textfield-createquest', value: model.questName, onInput: _user$project$Page_CreateQuest_Update$EditQuestName, label: 'Quest Name', $class: _elm_lang$core$Maybe$Nothing}),
																			_1: {
																				ctor: '::',
																				_0: _user$project$Component_TextArea$textArea(
																					{id: 'description-textarea-createquest', value: model.questDescription, label: 'Quest Description', $class: _elm_lang$core$Maybe$Nothing, onInput: _user$project$Page_CreateQuest_Update$EditQuestDescription}),
																				_1: {
																					ctor: '::',
																					_0: _user$project$Component_RaisedButton$raisedButton(
																						{
																							label: _user$project$Page_CreateQuest_View$validQuest(model) ? 'embark' : 'fill in details',
																							onClick: A2(
																								_elm_lang$core$List$all,
																								function (v) {
																								...
																								{
																									ctor: '::',
																									_0: _user$project$Page_CreateQuest_View$validQuest(model),
																									_1: {
																										ctor: '::',
																										_0: _elm_lang$core$Native_Utils.eq(model.submitPending, false),
																										_1: {ctor: '[]'}
																									}
																								}) ? _user$project$Page_CreateQuest_Update$SubmitCreateQuest : _user$project$Page_CreateQuest_Update$NoOp,
																							...
																							disabled: A2(
																								...
																								},
																								{
																									ctor: '::',
																									_0: _elm_lang$core$Native_Utils.eq(
																										_user$project$Page_CreateQuest_View$validQuest(model),
																										false),
																									_1: {
																										ctor: '::',
																										_0: model.submitPending,
																										_1: {ctor: '[]'}
																									}
																								})
																						}),
																							...
																							},
																							{
																								...
																								_0: A2(
																									...
																									},
																									{
																										ctor: '::',
																										_0: _rtfeldman$elm_css$Html_Styled$text(
																											model.submitError ? 'Oops! was an error creating this quest' : ''),
																										_1: {ctor: '[]'}
																									}),
																								_1: {ctor: '[]'}
																							}),
...
var _user$project$Page_QuestDetails_SuggestedQuestsList$suggestedQuestsList = F2(
					...
					_rtfeldman$elm_css$Html_Styled$a,
					{
						...
						_1: {
							...
							_0: _rtfeldman$elm_css$Html_Styled_Events$onClick(
								_user$project$Page_QuestDetails_Update$ToggleShowingSuggestedSideQuests(!isOpen)),
							_1: {
								ctor: '::',
								_0: _rtfeldman$elm_css$Html_Styled_Attributes$css(
									{
					...
					},
					{
						...
						_0: A2(
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _rtfeldman$elm_css$Html_Styled_Attributes$class('fa fa-envelope'),
										_1: {ctor: '[]'}
									},
									{ctor: '[]'}),
								_1: {ctor: '[]'}
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _rtfeldman$elm_css$Html_Styled$text('Thou hath mail!'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
										...
										_0: _rtfeldman$elm_css$Html_Styled_Attributes$css(
											{
												...
												_1: {
													...
													_1: {
														ctor: '::',
														_0: _rtfeldman$elm_css$Css$transform(
															_rtfeldman$elm_css$Css$rotateX(
																isOpen ? _rtfeldman$elm_css$Css$deg(180) : _rtfeldman$elm_css$Css$deg(0))),
														_1: {ctor: '[]'}
													}
												}
											}),
									...
									},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _rtfeldman$elm_css$Html_Styled_Attributes$class('fa fa-caret-up'),
												_1: {ctor: '[]'}
											},
											{ctor: '[]'}),
										_1: {ctor: '[]'}
							...
							_0: A2(
								_rtfeldman$elm_css$Html_Styled$div,
								{
									...
									_0: _rtfeldman$elm_css$Html_Styled_Attributes$css(
										{
											...
											_1: {
												...
												_1: {
													ctor: '::',
													_0: _rtfeldman$elm_css$Css$backgroundColor(_user$project$Theme$white),
													_1: {
														ctor: '::',
														_0: _rtfeldman$elm_css$Css$left(
															_rtfeldman$elm_css$Css$px(0)),
														_1: {
															...
															_1: {
																...
																_1: {
																	ctor: '::',
																	_0: _rtfeldman$elm_css$Css$height(
																		isOpen ? _rtfeldman$elm_css$Css$px(400) : _rtfeldman$elm_css$Css$px(0)),
																	_1: {ctor: '[]'}
																}
															}
														}
									...
									_1: {
										...
										_0: _rtfeldman$elm_css$Html_Styled_Attributes$style(
											{
												ctor: '::',
												_0: {ctor: '_Tuple2', _0: 'transition', _1: '.3s'},
												_1: {
													ctor: '::',
													_0: {ctor: '_Tuple2', _0: 'box-shadow', _1: _user$project$Theme$cardBoxShadow},
													_1: {ctor: '[]'}
												}
											}),
										_1: {ctor: '[]'}
								...
								},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _rtfeldman$elm_css$Html_Styled_Attributes$class('collection'),
											_1: {
												ctor: '::',
												_0: _rtfeldman$elm_css$Html_Styled_Attributes$style(
													{
										...
										A2(
											...
											function (sideQuest) {
												return A2(
													...
													{
														ctor: '::',
														_0: _rtfeldman$elm_css$Html_Styled_Attributes$class('collection-item avatar'),
														_1: {
															ctor: '::',
															_0: _rtfeldman$elm_css$Html_Styled_Events$onClick(
																_user$project$Page_QuestDetails_Update$ToggleShowingSideQuestModal(
													...
													},
													{
															...
															_rtfeldman$elm_css$Html_Styled$img,
															{
																...
																_0: _rtfeldman$elm_css$Html_Styled_Attributes$src(
																	A2(
																		_elm_lang$core$Basics_ops['++'],
																		'https://graph.facebook.com/',
																		A2(_elm_lang$core$Basics_ops['++'], sideQuest.suggestedBy, '/picture?type=small'))),
																_1: {
																	ctor: '::',
																	_0: _rtfeldman$elm_css$Html_Styled_Attributes$class('circle'),
																	_1: {
																		ctor: '::',
																		_0: _rtfeldman$elm_css$Html_Styled_Attributes$css(
																			{
														...
														_1: {
															...
															_0: A2(
																...
																{
																	ctor: '::',
																	_0: _rtfeldman$elm_css$Html_Styled_Attributes$class('title'),
																	_1: {
																		ctor: '::',
																		_0: _rtfeldman$elm_css$Html_Styled_Attributes$css(
																			{
																...
																{
																	ctor: '::',
																	_0: _rtfeldman$elm_css$Html_Styled$text(sideQuest.name),
																	_1: {ctor: '[]'}
																}),
															_1: {
																ctor: '::',
																_0: A2(
																	...
																	{
																		ctor: '::',
																		_0: _rtfeldman$elm_css$Html_Styled$text(sideQuest.description),
																		_1: {ctor: '[]'}
																	}),
																_1: {
																	ctor: '::',
																	_0: A2(
																		...
																		{
																			ctor: '::',
																			_0: _rtfeldman$elm_css$Html_Styled_Attributes$class('secondary-content'),
																			_1: {ctor: '[]'}
																		},
																		{
																			ctor: '::',
...
var _user$project$Page_QuestDetails_SideQuestDetails$sideQuestDetails = function (sideQuest) {
	return _user$project$Component_Modal$modal(
		{
			noop: _user$project$Page_QuestDetails_Update$NoOp,
			content: A2(
				_rtfeldman$elm_css$Html_Styled$div,
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _rtfeldman$elm_css$Html_Styled$text('Would you like to accept this side quest?'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}),
			footer: A2(
				...
				{ctor: '[]'},
				{
					ctor: '::',
					_0: _user$project$Component_FlatButton$flatButton(
						{onClick: _user$project$Page_QuestDetails_Update$DeclineSuggestedSideQuest, label: 'NAY'}),
					_1: {
						ctor: '::',
						_0: _user$project$Component_RaisedButton$raisedButton(
							{onClick: _user$project$Page_QuestDetails_Update$AcceptSuggestedSideQuest, label: 'YAY', icon: _elm_lang$core$Maybe$Nothing, disabled: false}),
						_1: {ctor: '[]'}
					}
				}),
			id: 'side-quest-details-modal',
			open: true,
			onRequestClose: _user$project$Page_QuestDetails_Update$ToggleShowingSideQuestModal(_elm_lang$core$Maybe$Nothing)
		});
};

var _user$project$Page_QuestDetails_SideQuestForm$sideQuestForm = function (formParams) {
	return A2(
		_rtfeldman$elm_css$Html_Styled$div,
		{
			ctor: '::',
										...
										_1: {
											...
											_0: _rtfeldman$elm_css$Css$padding(
												_rtfeldman$elm_css$Css$px(
													formParams.open ? 16 : 0)),
											_1: {
												ctor: '::',
												_0: _rtfeldman$elm_css$Css$height(
													formParams.open ? _rtfeldman$elm_css$Css$px(400) : _rtfeldman$elm_css$Css$px(0)),
												_1: {ctor: '[]'}
											}
										}
									}
			...
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _rtfeldman$elm_css$Html_Styled$text('What Side Quest would help this adventurer by its completion?'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: _user$project$Component_TextField$textField(
							{id: 'sidequestform-textfield', value: formParams.name, onInput: _user$project$Page_QuestDetails_Update$EditSideQuestName, label: 'Side Quest Name', $class: _elm_lang$core$Maybe$Nothing}),
						_1: {
							ctor: '::',
							_0: _user$project$Component_TextArea$textArea(
								{id: 'sidequestform-textarea', value: formParams.description, label: 'Side Quest Description', $class: _elm_lang$core$Maybe$Nothing, onInput: _user$project$Page_QuestDetails_Update$EditSideQuestDescription}),
							_1: {
								ctor: '::',
								_0: A2(
									_rtfeldman$elm_css$Html_Styled$div,
									...
									},
									{
										ctor: '::',
										_0: _user$project$Component_FlatButton$flatButton(
											{onClick: _user$project$Page_QuestDetails_Update$HideSideQuestForm, label: 'Close'}),
										_1: {
											ctor: '::',
											_0: function () {
												var canSubmit = A2(
													...
													{
														ctor: '::',
														_0: !_elm_lang$core$Native_Utils.eq(formParams.description, ''),
														_1: {
															ctor: '::',
															_0: !_elm_lang$core$Native_Utils.eq(formParams.name, ''),
															_1: {ctor: '[]'}
														}
													});
												return _user$project$Component_RaisedButton$raisedButton(
													{
														disabled: A2(
															...
															},
															{
																...
																_1: {
																	ctor: '::',
																	_0: formParams.submitting,
																	_1: {ctor: '[]'}
																}
															}),
														label: canSubmit ? (formParams.submitting ? 'Loading' : 'Submit!') : 'Add details',
														onClick: _user$project$Page_QuestDetails_Update$SubmitSideQuestForm,
														icon: _elm_lang$core$Maybe$Nothing
													});
											}(),
											_1: {ctor: '[]'}
...
var _user$project$Page_QuestDetails_SideQuestForm$FormParams = F4(
	function (a, b, c, d) {
		return {name: a, description: b, open: c, submitting: d};
	});

var _user$project$Page_QuestDetails_View$loadedView = F4(
	function (quest, sideQuests, suggestedSideQuests, model) {
		return A2(
			_rtfeldman$elm_css$Html_Styled$div,
			{
				ctor: '::',
			...
			},
			{
						...
						_1: {
							...
							_0: A2(
								...
								},
								{
									...
									_1: {
										ctor: '::',
										_0: _user$project$Page_QuestDetails_SideQuestForm$sideQuestForm(
										...
										_1: {
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _rtfeldman$elm_css$Html_Styled$text('Care to propose a'),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
												_0: A2(
													_rtfeldman$elm_css$Html_Styled$a,
													{
														...
														_1: {
															...
															_1: {
																ctor: '::',
																_0: _rtfeldman$elm_css$Html_Styled_Events$onClick(
																	model.questFormOpen ? _user$project$Page_QuestDetails_Update$HideSideQuestForm : _user$project$Page_QuestDetails_Update$ShowSideQuestForm),
																_1: {ctor: '[]'}
															}
														}
													},
													{
														ctor: '::',
														_0: _rtfeldman$elm_css$Html_Styled$text(' Side Quest '),
														_1: {ctor: '[]'}
													}),
												_1: {
													ctor: '::',
													_0: A2(
														...
														{
															ctor: '::',
															_0: _rtfeldman$elm_css$Html_Styled$text('for this adventurer to complete while on their journey?'),
															_1: {ctor: '[]'}
														}),
													_1: {ctor: '[]'}
												}
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$core$Native_Utils.eq(
						_elm_lang$core$List$length(suggestedSideQuests),
						0) ? A2(
						_rtfeldman$elm_css$Html_Styled$div,
						{ctor: '[]'},
						{ctor: '[]'}) : A2(
						...
						{
							ctor: '::',
							_0: A2(_user$project$Page_QuestDetails_SuggestedQuestsList$suggestedQuestsList, model.showingSuggestedSideQuests, suggestedSideQuests),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _user$project$Component_Stepper$stepper(
										{
											steps: A2(
												_elm_lang$core$List$map,
												function (sideQuest) {
													return {title: sideQuest.name, description: sideQuest.description};
												},
												sideQuests)
										}),
									_1: {
										...
										_0: function () {
											...
											if (_p0.ctor === 'Just') {
												return _user$project$Page_QuestDetails_SideQuestDetails$sideQuestDetails(_p0._0);
											} else {
												return A2(
													_rtfeldman$elm_css$Html_Styled$div,
													{ctor: '[]'},
...
var _user$project$Page_QuestDetails_View$render = F2(
	function (taco, model) {
		var viewReady = A4(
			_elm_lang$core$Maybe$map3,
			F3(
				function (quest, sideQuests, suggestedSideQuests) {
					return A4(_user$project$Page_QuestDetails_View$loadedView, quest, sideQuests, suggestedSideQuests, model);
				}),
			model.quest,
			model.sideQuests,
...
var _user$project$Main$model = F2(
	function (flags, routeData) {
		return {
			taco: {flags: flags, username: _elm_lang$core$Maybe$Nothing, userId: _elm_lang$core$Maybe$Nothing, routeData: routeData},
			quests: _user$project$Page_Quests_Update$initialModel,
			myAdventurer: _user$project$Page_MyAdventurer_Update$initialModel,
			layout: _user$project$Page_Layout$initialModel,
			createQuest: _user$project$Page_CreateQuest_Update$initialModel,
			questDetails: _user$project$Page_QuestDetails_Update$initialModel
		};
	});
var _user$project$Main$Model = F6(
	function (a, b, c, d, e, f) {
		return {taco: a, quests: b, myAdventurer: c, layout: d, createQuest: e, questDetails: f};
	});
...
var _user$project$Main$view = function (model) {
	...
	var location = _p1._1;
	return A4(
		_user$project$Page_Layout$render,
			...
			switch (_p2.ctor) {
				case 'QuestsRoute':
					return A2(
						...
						A2(_user$project$Page_Quests_View$render, model.taco, model.quests));
				case 'QuestDetailsRoute':
					return A2(
						_rtfeldman$elm_css$Html_Styled$map,
						_user$project$Main$QuestDetailsMsg,
						A2(_user$project$Page_QuestDetails_View$render, model.taco, model.questDetails));
				case 'MyAdventurerRoute':
					return A2(
						_rtfeldman$elm_css$Html_Styled$map,
						_user$project$Main$MyAdventurerMsg,
						A2(_user$project$Page_MyAdventurer_View$render, model.taco, model.myAdventurer));
				case 'CreateQuestRoute':
					return A2(
						_rtfeldman$elm_css$Html_Styled$map,
						_user$project$Main$CreateQuestMsg,
						A2(_user$project$Page_CreateQuest_View$render, model.taco, model.createQuest));
				default:
					return A2(
						_rtfeldman$elm_css$Html_Styled$div,
						{ctor: '[]'},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _rtfeldman$elm_css$Html_Styled$text('NOT FOUND'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						});
	...
	return _elm_lang$core$Platform_Sub$batch(
		{
			...
			_0: A2(
				_elm_lang$core$Platform_Sub$map,
				_user$project$Main$CreateQuestMsg,
				_user$project$Ports$uploadQuestImageFinished(_user$project$Page_CreateQuest_Update$UploadQuestImageFinished)),
			_1: {
				ctor: '::',
				_0: _user$project$Ports$navigate(_user$project$Main$Navigate),
				_1: {ctor: '[]'}
			}
		});
};
			...
			case 'Init':
				...
				return {
					...
					_2: A2(
						...
						A2(_user$project$Request_SessionRequest$loadSession, taco.flags.apiEndpoint, location.search))
				};
			case 'Navigate':
				return {
					ctor: '_Tuple3',
					...
					_2: _elm_lang$navigation$Navigation$newUrl(_p3._0)
				};
			...
			case 'LoadSessionResult':
				if (_p3._0.ctor === 'Ok') {
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							taco,
							{username: _p8.username, userId: _p8.userId}),
						_1: _user$project$Types$TacoNoOp,
						_2: function () {
							var _p7 = taco.routeData;
							var route = _p7._0;
							var location = _p7._1;
							return _elm_lang$navigation$Navigation$modifyUrl(location.pathname);
						}()
					};
				} else {
					var _p9 = taco.routeData;
					var route = _p9._0;
					var location = _p9._1;
					return {
						ctor: '_Tuple3',
						_0: _elm_lang$core$Native_Utils.update(
							taco,
							{username: _elm_lang$core$Maybe$Nothing, userId: _elm_lang$core$Maybe$Nothing}),
						_1: _user$project$Types$TacoNoOp,
						_2: _elm_lang$navigation$Navigation$modifyUrl(location.pathname)
					};
				}
			default:
...
var _user$project$Main$update = F2(
	function (message, prevModel) {
		var _p10 = A2(_user$project$Main$tacoUpdate, message, prevModel.taco);
		var taco = _p10._0;
		var tacoMsg = _p10._1;
		var tacoCmd = _p10._2;
		var tacoUpdater = A2(_user$project$Util$onTacoUpdate, tacoMsg, taco);
		var _p11 = A5(
			tacoUpdater,
			_user$project$Main$QuestDetailsMsg,
			function (model) {
				return model.questDetails;
			},
			F2(
			...
			_user$project$Page_QuestDetails_Update$onTacoMsg(tacoMsg),
			A5(
				tacoUpdater,
				_user$project$Main$MyAdventurerMsg,
				function (model) {
					return model.myAdventurer;
				},
				F2(
				...
				_user$project$Page_MyAdventurer_Update$onTacoMsg(tacoMsg),
				A5(
					tacoUpdater,
					_user$project$Main$QuestsMsg,
					function (model) {
					...
					_user$project$Page_Quests_Update$onTacoMsg(tacoMsg),
					A5(
						tacoUpdater,
						_user$project$Main$CreateQuestMsg,
						function (model) {
							return model.createQuest;
						},
						F2(
						...
						_user$project$Page_CreateQuest_Update$onTacoMsg(tacoMsg),
						{
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								prevModel,
		...
		var updater = A4(_user$project$Util$getReducerFactory, model, taco, tacoCmd, commands);
		var _p12 = message;
		switch (_p12.ctor) {
			case 'CreateQuestMsg':
				return A4(
					...
					_user$project$Page_CreateQuest_Update$onMsg(_p12._0));
			case 'QuestsMsg':
				return A4(
					updater,
					_user$project$Main$QuestsMsg,
					...
					_user$project$Page_Quests_Update$onMsg(_p12._0));
			case 'LayoutMsg':
				return A4(
					updater,
					_user$project$Main$LayoutMsg,
					...
					_user$project$Page_Layout$onMsg(_p12._0));
			case 'MyAdventurerMsg':
				return A4(
					...
					_user$project$Page_MyAdventurer_Update$onMsg(_p12._0));
			case 'QuestDetailsMsg':
				return A4(
					...
					_user$project$Page_QuestDetails_Update$onMsg(_p12._0));
			default:
				return {
					ctor: '_Tuple2',
					_0: model,
...
var _user$project$Main$main = A2(
	...
	A2(
		...
		A2(_elm_lang$core$Json_Decode$field, 'apiEndpoint', _elm_lang$core$Json_Decode$string)));

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Page.CreateQuest.Update.Msg":{"args":[],"tags":{"EditQuestDescription":["String"],"SubmitCreateQuestResult":["Result.Result Http.Error Types.Quest"],"ShowFileUploadModal":[],"UploadQuestImageFinished":["( Bool, String )"],"OnFileChosen":["String"],"ConfirmFileUpload":["String"],"EditQuestName":["String"],"HideFileUploadModal":[],"SubmitCreateQuest":[],"NoOp":[]}},"Page.Quests.Update.Msg":{"args":[],"tags":{"GetQuestsResult":["Result.Result Http.Error (List Types.RecentPostedQuest)"],"NoOp":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Main.Msg":{"args":[],"tags":{"QuestsMsg":["Page.Quests.Update.Msg"],"OnLocationChange":["Navigation.Location"],"Init":[],"LayoutMsg":["Page.Layout.Msg"],"Navigate":["String"],"QuestDetailsMsg":["Page.QuestDetails.Update.Msg"],"CreateQuestMsg":["Page.CreateQuest.Update.Msg"],"LoadSessionResult":["Result.Result Http.Error Types.SessionInfo"],"MyAdventurerMsg":["Page.MyAdventurer.Update.Msg"]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Page.MyAdventurer.Update.Msg":{"args":[],"tags":{"GetQuestsByUserResult":["Result.Result Http.Error (List Types.RecentPostedQuest)"],"NoOp":[]}},"Page.Layout.Msg":{"args":[],"tags":{"ToggleSidenav":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"Page.QuestDetails.Update.Msg":{"args":[],"tags":{"ToggleShowingSuggestedSideQuests":["Bool"],"AcceptSideQuest":["String"],"SuggestSideQuestResult":["Result.Result Http.Error (List Types.SideQuest)"],"ShowSideQuestForm":[],"AcceptSuggestedSideQuest":[],"GetQuestDetailsResult":["Result.Result Http.Error Types.QuestDetailsResponse"],"HideSideQuestForm":[],"DecideSideQuestResult":["Result.Result Http.Error Types.QuestDetailsResponse"],"EditSideQuestName":["String"],"DeclineSuggestedSideQuest":[],"ToggleShowingSideQuestModal":["Maybe.Maybe Types.SideQuest"],"SubmitSideQuestForm":[],"EditSideQuestDescription":["String"],"NoOp":[],"DeclineSideQuest":["String"]}}},"aliases":{"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"},"Types.QuestDetailsResponse":{"args":[],"type":"{ quest : Types.RecentPostedQuest , sideQuests : List Types.SideQuest , suggestedSideQuests : List Types.SideQuest }"},"Types.SessionInfo":{"args":[],"type":"{ username : Maybe.Maybe String, userId : Maybe.Maybe String }"},"Types.SideQuest":{"args":[],"type":"{ name : String , description : String , guid : String , suggestedBy : String , id : String }"},"Types.Quest":{"args":[],"type":"{ name : String , description : String , imageUrl : String , id : String }"},"Types.RecentPostedQuest":{"args":[],"type":"{ name : String , description : String , imageUrl : String , id : String , guid : String , username : String , userId : String , upvotes : Int }"},"Navigation.Location":{"args":[],"type":"{ href : String , host : String , hostname : String , protocol : String , origin : String , port_ : String , pathname : String , search : String , hash : String , username : String , password : String }"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
