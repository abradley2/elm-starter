	...
	return _elm_lang$http$Http$request(
		{
			...
			headers: {
				...
				_0: A2(
					_elm_lang$http$Http$header,
					'Authorization',
					A2(_elm_lang$core$Basics_ops['++'], 'Bearer ', params.userToken)),
				_1: {ctor: '[]'}
			},
			url: A2(
				_elm_lang$core$Basics_ops['++'],
...
var _user$project$View_MyAdventurerView_Main$topCopy = function (model) {
	return _user$project$View_MyAdventurerView_Main$noQuests(model) ? A2(
...
var _user$project$View_SideQuestsView_SideQuestForm$FormParams = F4(
	function (a, b, c, d) {
...
var _user$project$View_SideQuestsView_Main$ready = F3(
	function (model, quest, sideQuests) {
		return A2(
			_rtfeldman$elm_css$Html_Styled$div,
			{
				ctor: '::',
...
var _user$project$View_QuestDetailsView_Main$view = F4(
